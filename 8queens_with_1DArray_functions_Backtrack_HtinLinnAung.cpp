...
int main ()
{
	...
	*/
	...
	while(loop1==0)				// Will break out of this while with 'break;'
	{	while(loop2==0)			// Will break out of this while with 'break;'
		{	while(q[c]<8)		// While row<8 in the current column
			{	q[c]++;					// row++
				...
				{	c--;					// Back-track
					...
					continue;				// If not, go to next row, "continue;"	
				}							// Go to next line of code, "continue;"	
